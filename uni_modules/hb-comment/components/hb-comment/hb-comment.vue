        ...
        <view class="comment-box-item">
          ...
          <view class="comment-main">
            ...
            <view class="comment-main-top">
              ...
              <!-- <view class="zan-box" @click="like(item._id)">
            ...
            <view class="comment-main-content">
              ...
              <span v-if="item.content.length > 60">
                ...
                <span class="foot-btn" @click="showMore(item._id)">
            ...
            <view class="comment-main-foot">
              ...
              <view
                class="foot-btn"
                @click="reply(item.nickName, item.nickName, item._id)"
                >回复</view
              >
              <view
                class="foot-btn"
              ...
              >
                ...
                <view class="comment-main">
                  <view class="sub-comment-main-top">
                    ...
                    <!-- <view class="zan-box" @click="like(each._id)">
                  ...
                  <view class="comment-main-content">
                    ...
                    <span v-if="each.content.length > 60">
                      ...
                      <span class="foot-btn" @click="showMore(each._id)">
                  ...
                  <view class="comment-main-foot">
                    <view class="foot-time">{{
                      $u.timeFormat(each.creatorTime, "yyyy-mm-dd hh:MM:ss")
                    }}</view>
                    <view
                      class="foot-btn"
                      @click="reply(item.nickName, each.nickName, item._id)"
                    >
                      回复</view
                    >
                    <view
...
export default {
  ...
  methods: {
    ...
    reply(pUser, reUser, pId) {
      console.log("xx", pUser, reUser, pId);
    ...
    likeComplete(commentId) {
      for (var i in this.commentData.comment) {
        if (this.commentData.comment[i]._id == commentId) {
        ...
        for (var j in this.commentData.comment[i].children) {
          if (this.commentData.comment[i].children[j]._id == commentId) {
